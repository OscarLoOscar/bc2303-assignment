...
import com.codewave.project.crypto.channel.infra.util.RedisUtil;
...
public class RedisConfig {
  ...
  @Bean
  public RedisTemplate<String, ExchangeResp> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
    RedisTemplate<String, ExchangeResp> template = new RedisTemplate<>();
    template.setConnectionFactory(redisConnectionFactory);
    template.setDefaultSerializer(new Jackson2JsonRedisSerializer<>(ExchangeResp.class));
    return template;
  }

  @Bean
  public RedisTemplate<String, ExchangeReq> redisTemplate2(RedisConnectionFactory redisConnectionFactory) {
    RedisTemplate<String, ExchangeReq> redisTemplate = new RedisTemplate<>();
