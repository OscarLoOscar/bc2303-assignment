...
@RestController
@RequestMapping(value = "/crypto/channel/mobile/v1")
public class CoinMobileController implements ExchangeOperation, TradeOperation {
  ...
  public ChannelDto getExchange(Currency curr1, Currency curr2) {
    ChannelResp channelResp = adminService.getChannel(Source.MOB, Trantype.EXCHANGE);
